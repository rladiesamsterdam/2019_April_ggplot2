...
# --------- 5 ------------------
# We will reuse the idea of plot g4, but add facet_wrap. Compare 2 plots: what plot do you find the most informative? 
...
g6 = ggplot(fastfood_calories_subset, aes(x=variable, y=value, fill=variable)) + 
  ...
g6
